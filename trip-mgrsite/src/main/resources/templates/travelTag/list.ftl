    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".hotBtn").click(function () {
                ...
                var id = $(this).data("id");
                $.get("/travelTag/changeHotValue", {hot:hot, id:id}, function (data) {
                    if(data.success){
                        window.location.reload();
                    }else{
                        $.messager.alert("温馨提示", data.msg);
...
<div class="container-fluid " style="margin-top: 20px">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="page-head-line">游记标签管理</h1>
                </div>
            </div>
            <#setting number_format="#">
            <!--高级查询--->
            <form class="form-inline" id="searchForm" action="/travelTag/list" method="post">
...
-->
                           <a href="javascript:;" class="btn btn-danger btn-xs deleteBtn"
                              data-url="/travelTag/delete?id=${entity.id}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">游记标签添加/编辑</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="/travelTag/saveOrUpdate" method="post" id="editForm">
                    <input type="hidden" value="" name="id">
                    <div class="form-group">
                        <label  class="col-sm-3 control-label">名称：</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name"  placeholder="请输入游记标签名称">
                        </div>
                    </div>
