...
<head>
    ...
    <script>
        $(function () {
            $(".mine_tag").click(function () {
                $('.mine_tag').removeClass('on');
                $(this).addClass("on");
            })
        })
    </script>
    ...
    <div class="banner">
        <div class="tags_bar">
            <div class="center clearfix">
                <ul class="flt2">
                    <li class="on mine_tag"><a class="tags_link" href="/mine/home" title="我的窝">我的窝</a></li>
                    <li class="mine_tag"><a class="tags_link" href="/mine/mytravelnotes?userId=${user.id}" title="我的游记">我的游记</a></li>
                    <li class="mine_tag"><a class="tags_link" href="/mine/review" title="我的点评">我的点评</a></li>
                    <li id="_j_pathnav" class="mine_tag"><a class="tags_link" href="/mine/travelcollection" title="我的收藏">我的收藏</a></li>
                    <li class="mine_tag"><a class="tags_link" href="javascript:;" title="我的订单">我的订单</a></li>
                    <li class="mine_tag"><a class="tags_link" href="/mine/setting" title="设置">设置</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="center clearfix">
        ...
        <div class="content flt2">
            ...
            <div class="common_block my_ask my_dp" id="_j_commentwrap">
                        ...
                        <li class="first">
                            ...
                            <dl>
                                ...
                                <div class="dp_title"><a href="javascript:;"
                                                         target="_blank"><span>${vc.view.name!}</span><br>${vc.view.engName!}</a>
                                </div>
                                <div class="MStar">
                                    <div class="MStarIco MStarL${vc.starNum}"><span></span></div>
                                    <span class="MStarTips"></span>
                                </div>
                                </dt>
                                <dd>
                                    <div class="dp_detail">
                                        <div class="dp_word">${vc.content}<br>
                                            ${(vc.view.name)!}
                                        </div>
                                        <div class="dp_pics">
                                            <ul class="clearfix">
                                        ...
                                        <div class="dp_comment MInfoNum"><i
                                                class="MIcoComment"></i><span><strong>${vc.commentnum!}</strong>条回复</span></div>
                                    </div>
                                </dd>
                            </dl>
                             </#list>
                ...
                <div class="more_notes">
                    <a href="javascript:;">共<strong>${totalcommentnum}</strong>点评</a>
                </div>
            </div>
        </div>
    </div>
